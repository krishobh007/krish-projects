module SeedGalleriaEmailTemplates
  # encoding: utf-8
  def create_galleria_email_templates(hotel = nil)
    
    theme = EmailTemplateTheme.find_or_create_by_name_and_code('Galleria', 'guestweb_galleria')
