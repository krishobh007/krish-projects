...
# since you don't have to restart the web server when you make code changes.
  ...
  :email => {
    ...
    :sender_address => %{"SNT ERROR NOTIFIER" <alexsam374@gmail.com>},
    :exception_recipients => %w{shiju@stayntouch.com, shiju-d@stayntouch.com, 
                                rashila@stayntouch.com, ganesh@stayntouch.com}
  }
  
  config.action_mailer.default_url_options = { host: 'https://pms-release.stayntouch.com' }
  config.action_mailer.asset_host = 'https://pms-release.stayntouch.com'
  ...
  Paperclip::Attachment.default_options[:fog_directory] = 'ROVER_QA'
  Paperclip::Attachment.default_options[:fog_host] = 'https://b1ec6c20e16dc8bb91fd-4c48449b1b89f0df44d9c84eda87eb79.ssl.cf2.rackcdn.com'
end
