...
json.data do 
  ...
  json.results @sub_categories.select{ |sub_category| sub_category.has_valid_branches? } do |sub_category|
    json.component_id sub_category.id.to_s
    json.component_name sub_category.name.to_s
    json.component_type sub_category.component_type.to_s
    json.description sub_category.description.to_s
    json.icon_url sub_category.icon.andand.image.andand.url(:original).to_s
    json.icon_name sub_category.icon.andand.image.andand.name.to_s
    json.page_template sub_category.page_template.to_s
    json.image_url sub_category.image.andand.image.andand.url(:original).to_s
    ...
    json.last_updated sub_category.updated_at.to_i.to_s
