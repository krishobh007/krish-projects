...
json.early_checkin_charge_code current_hotel.settings.early_checkin_charge_code.to_s
...
json.early_checkin_levels @early_checkin_charges do |early_checkin_charge|
  ...
  json.start_time early_checkin_charge.start_time.in_time_zone(current_hotel.tz_info).strftime("%I:%M %p")
  json.addon_id early_checkin_charge.addon_id
  json.charge early_checkin_charge.charge
end
